...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://ttttechnicalaks7:cHyZwKd4s5z4OXd4@cluster0.cmxxezj.mongodb.net/?retryWrites=true&w=majority") #mongo db url
